...
public class Block implements IBlock {
    ...
    private String root; // hash du bloc actuel?
    ...
    public void calculateRoot() {
        root = HashfromString.sha256Hash(Integer.toString(depth) + transactions.toString() + Integer.toString(nounce)); // (il faut utiliser cette fonction pour hasher les transactions dans cette méthode)
    }
